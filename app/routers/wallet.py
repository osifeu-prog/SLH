...
async def set_wallet(
    ...
    \"\"\"
    wallet = db.query(models.Wallet).filter(models.Wallet.telegram_id == telegram_id).first()
    ...
    if wallet is None:
        ...
        wallet.slh_address = payload.slh_address or wallet.slh_address or wallet.bnb_address
